...
import { ShoppingCart, Package, BarChart3, Wallet, ShoppingBag, Menu, X, Bold, Settings, Settings2  } from 'lucide-react';
...
//Estructura del Layout
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      {/* Sidebar */}
      <div className={`bg-white border-r border-gray-200 flex flex-col shadow-sm z-10 transition-all duration-1000 ${
        sidebarOpen ? 'w-50' : 'w-25'
      }`}>
        <div className="p-5 flex items-center justify-between border-b border-gray-200">
          ...
          {sidebarOpen && <h1 className="text-xl font-bold text-gray-800 hover:text-orange-600 transition-colors duration-1000 position-relative">SimplePOS</h1>}
        </div>
